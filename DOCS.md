...
**Zigduck2mqttnix** takes care of entire house *(lights, automations, timers, dimmers, TVs, voice assistant, etc ..)*  
...
[Use the house.nix module](https://github.com/QuackHack-McBlindy/zigduck2mqttnix/tree/main/modules/house.nix)
